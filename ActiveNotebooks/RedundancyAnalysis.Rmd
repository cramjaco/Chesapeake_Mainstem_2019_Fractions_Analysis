...
```{r}
rdaConstrained_env3 <- rda(wideASVs_log ~ Salinity  + Oxygen + Depth_m + sqrt(Size_Class), data = sampleData01 %>% mutate(Oxygen = log(Oxygen + 0.03)))
...
rdaConstrained_env2 <- rda(wideASVs_log ~ Salinity  + Oxygen + sqrt(Size_Class), data = sampleData01 %>% mutate(Oxygen = log(Oxygen + 0.03)))
```{r}
rdaConstrained_NoFree_Env <- rda(wideASVs_log_NoFree ~ Salinity + Oxygen + sqrt(Size_Class), data = sampleData_NoFree %>% mutate(Oxygen = log(Oxygen + 0.03)))
```
...
```{r}
rdaConstrained_NoSmall_Env <- rda(wideASVs_log_NoSmall ~ Salinity + Oxygen + sqrt(Size_Class), data = sampleData_NoSmall %>% mutate(Oxygen = log(Oxygen + 0.03)))
```
