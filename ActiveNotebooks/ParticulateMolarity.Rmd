...
```{r}
cb_plotter(CarbonPerLiter/MassperLiter * (12/1000), logify = TRUE, lab = "POC/Mass (mg/mg)")
cb_plotter(NitrogenPerLiter/MassperLiter * (14/1000), logify = TRUE, lab = "PON/Mass (mg/mg)")
```
